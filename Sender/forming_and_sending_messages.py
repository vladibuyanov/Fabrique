...
def forming_and_sending_messages():
    """
    ...
    # Выбор рассылки, которая должна произойти сегодня
    today = datetime.datetime.today()
    # Все рассылки для отправки
    mailing_list_to_sent = MailingList.objects.filter(date_of_mailing=today)
    # Одна рассылка
    for mail_to_sent in mailing_list_to_sent:
        # Текст рассылки
